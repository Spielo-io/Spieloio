...
public class Tictactoe {
	...
	private void initialize() {
		...
		xCount.setFont(new Font("Lucida Grande", Font.BOLD, 40));
		...
		oCount.setFont(new Font("Lucida Grande", Font.BOLD, 40));
		...
		btnReset.setFont(new Font("Lucida Grande", Font.BOLD, 24));
		...
		btnExit.setFont(new Font("Lucida Grande", Font.BOLD, 24));
